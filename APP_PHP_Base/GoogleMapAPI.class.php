...
/*****************************************************
* 
* Edité par tibeoh pour le site du zero 
...
class GoogleMapAPI {
     ...
     * @var string
     */
    var $js_alert = '<strong>Javascript must be enabled in order to use Google Maps.</strong>';
    ...
    */                                                                                                                           
    ...
    function getMapJS() {
		...
		//integration obligatoire pour ie
    ...
    function getMap() {
        ...
        if(!empty($this->js_alert)) {
            $_output .= '<noscript><p>' . $this->js_alert . '</p></noscript>' . "\n";
        }
