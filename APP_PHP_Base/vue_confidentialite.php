...
<p>Formulaire d'inscription au site Web
...
<p> Vos renseignements sont également collectés par le biais de l'interactivité pouvant s'établir entre vous et notre site Web et ce, de la façon suivante:
<ul>
  <li> Statistiques </li>
  <li>Contact </li>
  <li>Gestion du site Web (présentation, organisation) </li>
...
<p> Nous utilisons les renseignements ainsi collectés pour les finalités suivantes :
  <ul>
<li>Forum ou aire de discussion </li>
<li> Commentaires </li>
<li> Droit d'opposition et de retrait </li>
 </ul>
...
Section du site web : www.move-out.com/Monprofil </p>
...
Section du site web : www.move-out.com/
Sécurité
...
Notre site Web contient des sections destinées aux enfants. La collecte de leurs renseignements personnels se fait avec le consentement des parents ou du représentant de l'enfant. Nous demandons le consentement de ces derniers par le biais :
<ul>
